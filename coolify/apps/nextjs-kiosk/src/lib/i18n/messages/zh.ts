...
export const zh: KioskMessages = {
  ...
  steps: {
    ...
    location: {
      ...
      scan: "扫描作业场所",
      close: "停止扫描",
      pendingScanned: (code: string) => `已扫描: ${code}（开始时记录）`,
      deviceDefaultHint: (label: string) => `未扫描时，将记录“${label}”`,
      deviceDefaultNone: "该终端未设置默认作业场所，未扫描时将不记录",
