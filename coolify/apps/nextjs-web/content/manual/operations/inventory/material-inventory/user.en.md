...
---
This page explains the 「**素材**」 (materials) tab and the 「**仕掛品**」 (work in progress) tab of [inventory management](/manual/en/operations/production/product-inventory/user) (operation code `ST01`). You can check how much material you can use now, and how much is being made right now.
