...
You can check stock in [inventory management](/manual/en/operations/inventory/product-inventory/user) (ST01). Pieces still being made are shown on the 「**仕掛品**」 (work in progress) tab of the same app.
