...
1 単位あたりの価格です。**ここに入れた金額が、価格試算の材料費の参考価格として使われます**ので、実際の取引価格を入れてください。
...
**Q.「編集」ボタンが出ません。**
A. 直せるのは「下書き」のときだけです。承認依頼を出したあとは直せません。無理に操作すると「**下書きの素材発注書のみ編集できます**」と表示されます。直したいときは、承認する人に差し戻してもらってください。
