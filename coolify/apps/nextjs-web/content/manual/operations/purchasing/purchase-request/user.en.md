...
- **素材** (material) … the bar stock and other raw material used in machining. You pick one that is already registered in the [material master](/manual/en/operations/masters/material/user).
...
- The **material you want must be registered in the [material master](/manual/en/operations/masters/material/user)**. You cannot choose a material that is not registered.
- If you want to name a receiving place, that **[site](/manual/en/operations/masters/plant/user) must be registered**.
...
A [material purchase order](/manual/en/operations/purchasing/purchase-order/user) is created as a draft with the same line items, and you move to its screen. The request becomes 「**発注済**」 (ordered) and shows a link to the new purchase order number.
