...
|-------|--------------|------|----------|
| 1. Check product stock | Split into the portion already in stock and the portion to make new | Production control | [Inventory](/manual/en/operations/production/product-inventory/user) (`ST01`) |
| 2. Check material | See whether there is enough material to make it | Production control | [Inventory](/manual/en/operations/production/material-inventory/user) (`ST01`) |
