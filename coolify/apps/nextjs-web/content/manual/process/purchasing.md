...
承認された依頼から発注書を作る（依頼を通さず直接作ることもできる）。ここで**仕入先・単価・入荷予定日**を決める。単価は後で価格試算の材料費の参考にも使われるため、実際の取引価格を入れる。
...
- 在庫の確認 … [在庫管理](/manual/ja/operations/inventory/inventory-management/user)
