/**
 * DisplayPreferencesStyle — 文字の大きさ・太さ・書体を :root へ流し込む `<style>`。
 *
 ...
 * Mantine の太さ・書体変数）— 適用の仕方はそちらの 1 か所だけが持つ。書体は
 * この画面（アプリ本体）だけの設定で、PDF には効かない（lib/pdf.ts は常に
 * 埋め込みの Noto Sans JP を使う）。
