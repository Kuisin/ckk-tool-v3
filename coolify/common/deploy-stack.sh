...
#
# This is the manual flow for every stack that is NOT built by Coolify — i.e.
# everything in this directory (coolify/common/). The Coolify-built apps live in
# coolify/apps/ and deploy from GitHub via ../platform/deploy.sh instead; do not
# use this script for those.
#
