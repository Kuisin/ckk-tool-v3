...
WITH target AS (
  ...
  ('rest_starts',             '休憩開始打刻'),
  ('rest_ends',               '休憩終了打刻'),
  ('wt_scheduled',            '所定内時間(分)'),
  ('wt_holiday',              '休日時間(分)'),
  ('wt_holiday_night',        '休日深夜(分)'),
  ('absence_part',            '欠勤(パート)時間休(分)'),
  ('absence_leave',           '欠勤(産休育休)時間休(分)'),
  ...
  ('scheduled_minutes',       '所定内時間(分)'),
  ('holiday_minutes',         '休日時間(分)'),
  ('holiday_night_minutes',   '休日深夜(分)'),
  ('absence_part_minutes',    '欠勤(パート)時間休(分)'),
  ('absence_leave_minutes',   '欠勤(産休育休)時間休(分)'),
  -- インポート履歴 / LDAP同期ログ
  ('finished_at',             '完了時刻'),
  ('start_date',              '開始日'),
  ('end_date',                '終了日'),
