 ...
 * This source code is licensed under the MIT license.
 * See the LICENSE file in the root directory of this source tree.
 */const Bn=[["path",{d:"M14 3v4a1 1 0 0 0 1 1h4",key:"svg-0"}],["path",{d:"M17 21h-10a2 2 0 0 1 -2 -2v-14a2 2 0 0 1 2 -2h7l5 5v11a2 2 0 0 1 -2 2",key:"svg-1"}]],Wn=F("outline","file","File",Bn);/**
 * @license @tabler/icons-react v3.44.0 - MIT
 *
 * This source code is licensed under the MIT license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the MIT license.
 * See the LICENSE file in the root directory of this source tree.
 */const Zn=[["path",{d:"M12 3c.132 0 .263 0 .393 0a7.5 7.5 0 0 0 7.92 12.446a9 9 0 1 1 -8.313 -12.454l0 .008",key:"svg-0"}]],Qn=F("outline","moon","Moon",Zn);/**
 * @license @tabler/icons-react v3.44.0 - MIT
 *
 * This source code is licensed under the MIT license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the MIT license.
 * See the LICENSE file in the root directory of this source tree.
 */const to=[["path",{d:"M8 12a4 4 0 1 0 8 0a4 4 0 1 0 -8 0",key:"svg-0"}],["path",{d:"M3 12h1m8 -9v1m8 8h1m-9 8v1m-6.4 -15.4l.7 .7m12.1 -.7l-.7 .7m0 11.4l.7 .7m-12.1 -.7l-.7 .7",key:"svg-1"}]],no=F("outline","sun","Sun",to);function xt({nodes:e,selected:s,onSelect:n}){return o.jsx(v,{component:"nav","aria-label":"Design files",children:e.map(a=>o.jsx(vt,{node:a,selected:s,onSelect:n,depth:0},a.modulePath??a.name))})}function vt({node:e,selected:s,onSelect:n,depth:a}){var u;const i=!!((u=e.children)!=null&&u.length),[t,r]=f.useState(!0);if(i)return o.jsxs(v,{children:[o.jsx(We,{onClick:()=>r(p=>!p),w:"100%",py:4,pl:a*12+4,pr:8,style:{borderRadius:"var(--mantine-radius-sm)"},children:o.jsxs(v,{component:"span",style:{display:"flex",alignItems:"center",gap:4,minWidth:0},children:[o.jsx(an,{size:14,style:{flexShrink:0,transition:"transform 150ms ease",transform:t?"rotate(90deg)":void 0}}),t?o.jsx(qn,{size:16,style:{flexShrink:0}}):o.jsx(Kn,{size:16,style:{flexShrink:0}}),o.jsx(L,{size:"sm",fw:500,truncate:!0,children:e.name})]})}),o.jsx(ct,{expanded:t,children:e.children.map(p=>o.jsx(vt,{node:p,selected:s,onSelect:n,depth:a+1},p.modulePath??p.name))})]});const c=e.modulePath===s;return o.jsx(We,{onClick:()=>e.modulePath&&n(e.modulePath),w:"100%",py:4,pl:a*12+24,pr:8,style:{borderRadius:"var(--mantine-radius-sm)",background:c?"var(--mantine-color-blue-light)":void 0},children:o.jsxs(v,{component:"span",style:{display:"flex",alignItems:"center",gap:6,minWidth:0},children:[o.jsx(Wn,{size:15,style:{flexShrink:0,opacity:.7}}),o.jsx(L,{size:"sm",truncate:!0,c:c?"blue":void 0,fw:c?500:void 0,children:e.name})]})})}function oo(e){const s="/ckk-tool-v3/design-preview/",n=new URL(`${s}frame.html`,window.location.origin);return n.searchParams.set("design",e.design),n.searchParams.set("viewport",e.viewport),n.searchParams.set("scheme",e.scheme),n.searchParams.set("mode",e.mode),e.remountKey!=null&&n.searchParams.set("t",String(e.remountKey)),`${n.pathname}${n.search}`}function io({url:e,design:s,viewport:n="desktop",scheme:a,mode:i,remountKey:t=0,onViewportChange:r}){const c=n==="mobile",u=oo({design:s,viewport:n,scheme:a,mode:i,remountKey:t});return o.jsxs(v,{style:{border:"1px solid var(--mantine-color-default-border)",borderRadius:10,overflow:"hidden",boxShadow:"0 8px 40px rgba(0,0,0,0.18)",background:"var(--mantine-color-body)",display:"flex",flexDirection:"column",width:"100%",maxWidth:c?390:1280,margin:"0 auto"},children:[o.jsxs(v,{style:{background:"var(--mantine-color-default-hover)",borderBottom:"1px solid var(--mantine-color-default-border)",padding:"10px 14px 10px",flexShrink:0},children:[o.jsxs(H,{gap:8,mb:10,justify:"space-between",children:[o.jsxs(H,{gap:8,children:[o.jsx(v,{style:{width:12,height:12,borderRadius:"50%",background:"#ff5f57",border:"1px solid rgba(0,0,0,0.12)"}}),o.jsx(v,{style:{width:12,height:12,borderRadius:"50%",background:"#febc2e",border:"1px solid rgba(0,0,0,0.12)"}}),o.jsx(v,{style:{width:12,height:12,borderRadius:"50%",background:"#28c840",border:"1px solid rgba(0,0,0,0.12)"}})]}),o.jsx(me,{label:c?"Switch to desktop":"Switch to mobile",withArrow:!0,children:o.jsx(W,{variant:"subtle",color:"gray",size:"sm","aria-label":c?"Switch to desktop":"Switch to mobile",onClick:()=>r==null?void 0:r(c?"desktop":"mobile"),children:c?o.jsx(Vn,{size:14}):o.jsx(Hn,{size:14})})})]}),o.jsxs(H,{gap:6,align:"center",children:[o.jsx(W,{variant:"subtle",color:"gray",size:"sm",disabled:!0,"aria-label":"Back",children:o.jsx(In,{size:14})}),o.jsx(W,{variant:"subtle",color:"gray",size:"sm",disabled:!0,"aria-label":"Forward",children:o.jsx(ln,{size:14})}),o.jsx(W,{variant:"subtle",color:"gray",size:"sm",disabled:!0,"aria-label":"Reload",children:o.jsx(ke,{size:14})}),o.jsxs(v,{style:{flex:1,background:"var(--mantine-color-default)",borderRadius:6,padding:"4px 10px",border:"1px solid var(--mantine-color-default-border)",display:"flex",alignItems:"center",gap:6},children:[o.jsx(cn,{size:11,color:"var(--mantine-color-green-6)",style:{flexShrink:0}}),o.jsx(L,{size:"xs",c:"dimmed",ff:"mono",truncate:!0,children:e})]})]})]}),o.jsx("iframe",{title:"Design preview",src:u,style:{width:"100%",height:c?700:600,border:0,display:"block",background:"var(--mantine-color-body)"}},u)]})}function pe(e,s){const[n,a]=f.useState(()=>new URLSearchParams(window.location.search).get(e)??s),i=f.useCallback(t=>{const r=new URLSearchParams(window.location.search);t?r.set(e,t):r.delete(e),window.history.replaceState(null,"",`?${r.toString()}`),a(t)},[e]);return[n,i]}function De(e,s){return s.trim().split(".").reduce((n,a)=>{if(n!=null&&typeof n=="object")return n[a]},e)}function Ke(e,s,n){const a=`{{#${n} `,i=`{{/${n}}}`;let t=1,r=s;for(;r<e.length;){const c=e.indexOf(a,r),u=e.indexOf(i,r);if(u===-1)throw new Error(`Unclosed {{#${n}}}`);if(c!==-1&&c<u)t++,r=c+a.length;else{if(t--,t===0)return{inner:e.slice(s,u),after:u+i.length};r=u+i.length}}throw new Error(`Unclosed {{#${n}}}`)}function so(e,s){return Ie(e,s)}function Ie(e,s){const n=[];let a=0;for(;a<e.length;){const i=e.indexOf("{{",a);if(i===-1){n.push(e.slice(a));break}i>a&&n.push(e.slice(a,i));const t=e.indexOf("}}",i+2);if(t===-1){n.push(e.slice(i));break}const r=e.slice(i+2,t).trim();if(r.startsWith("#each ")){const c=r.slice(6).trim(),{inner:u,after:p}=Ke(e,t+2,"each"),g=De(s,c);if(Array.isArray(g))for(const w of g){const m=w!=null&&typeof w=="object"?{...s,...w}:s;n.push(Ie(u,m))}a=p}else if(r.startsWith("#if ")){const c=r.slice(4).trim(),{inner:u,after:p}=Ke(e,t+2,"if");De(s,c)&&n.push(Ie(u,s)),a=p}else if(r.startsWith("/"))a=t+2;else{const c=De(s,r);n.push(c!=null?String(c):""),a=t+2}}return n.join("")}const ro=`/* Shared base styles for every PDF template. Flat / minimal: monochrome,
...
</head>`):r+t}function co(){const[e,s]=pe("template",he[0]??""),n=he.includes(e)?e:he[0]??null,a=b=>s(b??""),[i,t]=f.useState(null),[r,c]=f.useState("{}"),[u,p]=f.useState("{}"),[g,w]=f.useState(!1),[m,k]=f.useState(!1),[x,C]=f.useState(!1),[_,h]=f.useState(0);f.useEffect(()=>{if(!n){t(null),p("{}"),c("{}");return}w(!0),t(null);const b=Qe(n);Promise.all([yt[n](),b?wt[b]():Promise.resolve(null)]).then(([M,R])=>{t(M);const N=R||"{}";c(N),p(N),w(!1)})},[n,_]);const{processedHtml:l,jsonError:d}=f.useMemo(()=>{if(!i)return{processedHtml:null,jsonError:null};try{const b=JSON.parse(u);return{processedHtml:so(i,b),jsonError:null}}catch(b){return{processedHtml:i,jsonError:String(b)}}},[i,u]);async function S(){var b;if(!(!n||m)){k(!0);try{const M=n.slice(oe.length),R=await fetch(`/api/pdf?template=${encodeURIComponent(M)}`,{method:"POST"});if(!R.ok)throw new Error(`PDF generation returned ${R.status}`);const N=await R.blob(),D=R.headers.get("content-disposition"),X=((b=D==null?void 0:D.match(/filename="?([^"]+)"?/))==null?void 0:b[1])??`${j??"template"}.pdf`,Y=URL.createObjectURL(N),A=document.createElement("a");A.href=Y,A.download=X,document.body.appendChild(A),A.click(),document.body.removeChild(A),URL.revokeObjectURL(Y)}catch(M){console.error("PDF generation failed:",M)}finally{k(!1)}}}const j=n?je(n,oe,"html"):null,E=Qe(n??"")!==null;return o.jsxs(v,{style:{flex:1,display:"flex",minHeight:0},children:[o.jsx(v,{w:240,style:{flexShrink:0,borderRight:"1px solid var(--mantine-color-default-border)",background:"var(--mantine-color-body)"},children:o.jsx(lt,{h:"100%",p:"xs",children:Ze.length===0?o.jsx(L,{size:"sm",c:"dimmed",p:"xs",children:"No .html files in pdf-templates/ yet."}):o.jsx(xt,{nodes:Ze,selected:n,onSelect:a})})}),o.jsxs(v,{style:{flex:1,display:"flex",flexDirection:"column",minHeight:0},children:[n&&o.jsx(v,{px:"md",py:"xs",style:{borderBottom:"1px solid var(--mantine-color-default-border)",background:"var(--mantine-color-body)",flexShrink:0},children:o.jsxs(H,{justify:"space-between",children:[o.jsx(L,{size:"sm",c:"dimmed",ff:"monospace",children:j}),o.jsxs(H,{gap:"xs",children:[o.jsx(W,{variant:"default",title:"Reload template",onClick:()=>h(b=>b+1),children:o.jsx(ke,{size:16})}),E&&o.jsx(me,{label:x?"Hide data editor":"Edit JSON data",children:o.jsx(W,{variant:x?"filled":"default",onClick:()=>C(b=>!b),children:x?o.jsx(Ln,{size:16}):o.jsx(Xn,{size:16})})}),o.jsx(Ut,{size:"xs",leftSection:o.jsx(dn,{size:14}),onClick:S,disabled:!l,loading:m,children:"Save PDF"})]})]})}),o.jsxs(v,{style:{flex:1,display:"flex",minHeight:0},children:[o.jsx(v,{style:{flex:1,overflow:"auto",background:"var(--mantine-color-gray-2)",padding:32},children:n?g?o.jsx(Pe,{style:{minHeight:"100%"},children:o.jsxs(Te,{align:"center",gap:"xs",children:[o.jsx(st,{size:"sm"}),o.jsx(L,{size:"sm",c:"dimmed",children:"Loading…"})]})}):l?o.jsx(v,{style:{width:et,minHeight:tt,background:"white",boxShadow:"0 4px 32px rgba(0,0,0,0.18)",margin:"0 auto",overflow:"hidden"},children:o.jsx("iframe",{srcDoc:lo(l),title:j??"PDF Template",style:{width:et,height:tt,border:"none",display:"block"}},`${n}-${_}-${u}`)}):null:o.jsx(Pe,{style:{minHeight:"100%"},children:o.jsx(L,{c:"dimmed",children:he.length===0?"Drop an .html file into design-preview/pdf-templates/ to get started.":"Select a template from the tree on the left."})})}),x&&o.jsxs(v,{w:380,style:{flexShrink:0,borderLeft:"1px solid var(--mantine-color-default-border)",display:"flex",flexDirection:"column",background:"var(--mantine-color-body)"},children:[o.jsx(v,{px:"sm",py:"xs",style:{borderBottom:"1px solid var(--mantine-color-default-border)",flexShrink:0},children:o.jsxs(H,{justify:"space-between",children:[o.jsxs(H,{gap:"xs",children:[o.jsx(L,{size:"xs",fw:600,children:"JSON Data"}),d&&o.jsx(me,{label:d,multiline:!0,w:260,withArrow:!0,children:o.jsx(Ht,{color:"red",size:"xs",style:{cursor:"help"},children:"Parse error"})})]}),o.jsx(me,{label:"Reset to default",children:o.jsx(W,{size:"xs",variant:"subtle",onClick:()=>p(r),disabled:u===r,children:o.jsx(ke,{size:12})})})]})}),o.jsx("textarea",{value:u,onChange:b=>p(b.target.value),spellCheck:!1,style:{flex:1,resize:"none",border:"none",outline:"none",padding:"10px 12px",fontFamily:'ui-monospace, "Cascadia Code", "Fira Code", monospace',fontSize:"11px",lineHeight:1.6,background:"var(--mantine-color-body)",color:"var(--mantine-color-text)"}})]})]})]})]})}function uo(e){return`https://ckk.local/${e.replace("../designs/","").replace(/\.tsx$/,"").split("/").map(a=>a.replace(/([A-Z])/g,(i,t,r)=>r===0?t.toLowerCase():`-${t.toLowerCase()}`)).join("/")}`}function fo(){const[e,s]=pe("mode","ui"),n=e==="pdf"?"pdf":"ui",[a,i]=pe("design",ue[0]??""),t=ue.includes(a)?a:ue[0]??null,r=j=>i(j??""),[c,u]=pe("viewport","desktop"),p=c==="mobile"?"mobile":"desktop",[g,w]=pe("hidden","0"),m=g==="1",k=f.useMemo(()=>at(ue,{includeUnderscore:m}),[m]),[x,C]=f.useState(0),{toggleColorScheme:_}=nn(),l=on("light",{getInitialValueInEffect:!1})==="dark"?"dark":"light",d=l==="dark",S=t&&Bt(t)?"component":"page";return o.jsxs(Te,{gap:0,h:"100vh",children:[o.jsx(v,{p:"sm",style:{borderBottom:"1px solid var(--mantine-color-default-border)",background:"var(--mantine-color-body)"},children:o.jsxs(H,{justify:"space-between",children:[o.jsxs(H,{gap:"sm",children:[o.jsx(Wt,{order:5,style:{flexShrink:0},children:"Design Preview"}),n==="ui"&&t&&o.jsx(L,{size:"sm",c:"dimmed",ff:"monospace",children:je(t)})]}),o.jsxs(H,{gap:"xs",children:[n==="ui"&&o.jsx(me,{label:"`_` で始まる隠しファイル（_modals 等）を表示",withinPortal:!0,children:o.jsx(rn,{size:"xs",label:"_ files",checked:m,onChange:j=>w(j.currentTarget.checked?"1":"0")})}),n==="ui"&&o.jsx(W,{variant:"default",title:"Re-render",onClick:()=>C(j=>j+1),children:o.jsx(ke,{size:16})}),o.jsx(W,{variant:"default",title:d?"ライトモード":"ダークモード",onClick:()=>_(),"aria-label":"カラーモード切替",children:d?o.jsx(no,{size:16}):o.jsx(Qn,{size:16})}),o.jsx(sn,{size:"xs",value:n,onChange:j=>s(j),data:[{label:"UI Designs",value:"ui"},{label:"PDF Templates",value:"pdf"}]})]})]})}),n==="pdf"?o.jsx(co,{}):o.jsxs(v,{style:{flex:1,display:"flex",minHeight:0},children:[o.jsx(v,{w:240,style:{flexShrink:0,borderRight:"1px solid var(--mantine-color-default-border)",background:"var(--mantine-color-body)"},children:o.jsx(lt,{h:"100%",p:"xs",children:k.length===0?o.jsx(L,{size:"sm",c:"dimmed",p:"xs",children:"No .tsx files in designs/ yet."}):o.jsx(xt,{nodes:k,selected:t,onSelect:r})})}),o.jsx(v,{style:{flex:1,overflow:"auto",background:d?"var(--mantine-color-dark-8)":"var(--mantine-color-gray-2)",padding:24},children:t?o.jsx(io,{url:uo(t),design:t,viewport:p,scheme:l,mode:S,remountKey:x,onViewportChange:u}):o.jsx(Pe,{style:{minHeight:"100%"},children:o.jsx(Te,{align:"center",gap:"xs",children:o.jsx(L,{c:"dimmed",children:ue.length===0?"Drop a .tsx file into design-preview/designs/ to get started.":"Select a design file from the tree on the left."})})})})]})]})}const St=document.createElement("style");St.textContent="@font-face { font-family: 'Noto Sans JP'; src: url('/ckk-tool-v3/design-preview/design-assets/fonts/NotoSansJP-VariableFont_wght.ttf') format('truetype'); font-weight: 100 900; font-display: swap; }";document.head.appendChild(St);Gt.createRoot(document.getElementById("root")).render(o.jsx(U.StrictMode,{children:o.jsx(qt,{theme:Kt,colorSchemeManager:Jt,children:o.jsxs(Zt,{settings:{locale:"ja"},children:[o.jsx(B,{}),o.jsx(fo,{})]})})}));
