...
![Material receipt list mixing rows linked to PO numbers and rows with the direct-procurement badge, with the receipt-type filter](../../assets/screenshots/material-receipt-list-01.png)
...
![Material receipt detail of a PO receipt, showing the link to the material purchase order and the receipt summary](../../assets/screenshots/material-receipt-detail-01.png)

## List & search

- Columns: material (code + name) / supplier / receiving plant / quantity / receipt date / PO line (PO number or direct procurement).
- Filter with the search box (material code and name, supplier, PO number) and the **receipt type** (PO receipt / direct procurement).
