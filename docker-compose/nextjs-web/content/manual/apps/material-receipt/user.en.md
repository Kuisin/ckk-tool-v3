...
- **発注入荷** (arrival from an order) … an arrival of material ordered with a [material purchase order](/manual/en/apps/purchase-order/user). **It is recorded automatically.**
...
- The **material that arrived must be registered in the [material master](/manual/en/masters/material/user)**. You cannot choose a material that is not registered.
- To choose the site whose stock should go up, that **[site](/manual/en/masters/plant/user) must be registered**.
...
> ⚠️ When material you ordered with a purchase order arrives, do not register it here. Press 「**入荷完了**」 (Receiving complete) on the [material purchase order](/manual/en/apps/purchase-order/user) screen and the arrival record is created automatically.
...
- **発注明細** (order line) … for material that came from a purchase order, a link to the original [material purchase order](/manual/en/apps/purchase-order/user) is shown. Click it to check the order.
...
A. No. Please press 「**入荷完了**」 (Receiving complete) on the [material purchase order](/manual/en/apps/purchase-order/user) screen. The arrival record is created from there automatically. If you type it in here as well, the same material goes into stock twice.
