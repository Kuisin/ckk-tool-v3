---
title: "素材入荷 — 操作マニュアル"
description: "操作コード PU01。素材が拠点に届いたことを記録し、素材在庫へ入庫するアプリです。"
screenshots: [material-receipt-list-01, material-receipt-detail-01]
---
操作コード **PU01**。素材が拠点に届いたことを記録し、素材在庫へ入庫するアプリです。
...
- **発注入荷** — [素材発注書（PU03）](/manual/ja/apps/purchase-order/user)の「入荷完了」操作から **自動で** 登録される入荷。一覧では発注番号（PO-…）へのリンクが表示されます。
