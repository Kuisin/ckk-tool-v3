...
Sometimes the company that sends you the order ([Customer](/manual/en/masters/customer/user)) is not the company that actually uses the product in its plant. This happens, for example, when the order comes through a trading company. In such cases, you register the company that actually uses the product here.
...
It is mainly used for large accounts, when you want your team to know "which plant is using this product". Register the company that sends you the order in [Customer](/manual/en/masters/customer/user) instead.
...
A. No. Register it only in [Customer](/manual/en/masters/customer/user). This screen is for when "the company that orders" and "the company that uses" are different.
