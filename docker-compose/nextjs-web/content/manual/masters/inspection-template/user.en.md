...
When you attach a template to a [指示書 (work order)](/manual/en/apps/work-order/user), the floor follows this template when entering the inspection record.
...
- If you want to link the template to an inspection step, the inspection step must first be registered in the [process step master (工程マスタ)](/manual/en/masters/process-step/user).
