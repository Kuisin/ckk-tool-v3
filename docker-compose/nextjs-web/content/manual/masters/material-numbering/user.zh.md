...
---
这是用于登记组成[材种](/manual/zh/masters/material-type/user)代码和[材料](/manual/zh/masters/material/user)代码的「部件」的画面。操作码是 `MS07`。
...
日常业务中几乎不会打开本画面。它是 **在[材种](/manual/zh/masters/material-type/user)或[材料](/manual/zh/masters/material/user)的登记画面上找不到想选的选项时** 才使用的画面。
...
> 💡 「直径」（直径）和「全長」（全长）在登记[材料](/manual/zh/masters/material/user)时会 **当场自动添加**。在本画面事先添加，只是为了预先准备好选项，或者为了整理名称。
