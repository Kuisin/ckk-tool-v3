...
[产品库存](/manual/zh/apps/product-inventory/user)和[材料库存](/manual/zh/apps/material-inventory/user)按据点分开管理，材料的到货地点等也从这里登记的据点中选择。
...
- 使用本应用需要 **主数据权限**。
- 据点内部的 **仓库和货架** 不在本应用中登记，请在[保管场所](/manual/zh/masters/storage-location/user)中登记。本应用只处理图纸。
...
图纸的登记和更换只能在本应用中进行。在[保管场所](/manual/zh/masters/storage-location/user)界面上，只能在这张图纸上放置标记。
...
**Q. 仓库和货架在哪里登记？**
A. 不在本应用，请在[保管场所](/manual/zh/masters/storage-location/user)中登记。
