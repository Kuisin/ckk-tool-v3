...
- 取引しているお客様の会社を登録できます。
- 登録すると、[価格表](/manual/ja/operations/sales/price-list/user) や [見積書](/manual/ja/operations/sales/quote/user) の「顧客」欄で選べるようになります。
- 会社の下に **支店** を登録できます。
...
- **顧客** … 注文をくれる会社のことです。実際に製品を使う会社とは別のことがあります（そちらは[最終需要家](/manual/ja/operations/masters/end-user/user)に登録します）。
...
登録した顧客は、[価格表](/manual/ja/operations/sales/price-list/user) → [見積書](/manual/ja/operations/sales/quote/user) → [受注請書](/manual/ja/operations/sales/order-acceptance/user) と、後の作業でずっと使われます。**会社名の書き方は最初にきちんと決めて登録してください。**
