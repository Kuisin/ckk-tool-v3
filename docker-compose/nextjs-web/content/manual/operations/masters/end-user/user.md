...
注文をくれる会社（[顧客](/manual/ja/operations/masters/customer/user)）と、その製品を実際に工場で使う会社が違うことがあります。商社を通して注文をいただく場合などです。そのようなときに、実際に使う会社をここに登録しておきます。
...
主に、大口のお取引で「どこの工場で使われている製品か」を社内で把握しておきたいときに使います。注文をくれる会社そのものは、[顧客](/manual/ja/operations/masters/customer/user)のほうに登録してください。
...
A. 必要ありません。[顧客](/manual/ja/operations/masters/customer/user)にだけ登録してください。この画面は「注文をくれる会社と使う会社が違う」ときのためのものです。
