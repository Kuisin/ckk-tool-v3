...
- **予定数量** … 作る予定の本数です。
- **承認状態** … 「承認待ち」「承認済」「差し戻し」が色つきのバッジで分かります。いま何段目かは詳細画面のカードに出ます。
...
3. 1 段目の承認をする人が「**承認**」を押します。
4. 承認設定で 2 段目以降がある場合は、続けてその段の人が「**承認**」を押します。最後の段まで通ると承認済になります。
5. 2 段階とも終わると、状態が「**承認済**」になり、作業を始められます。

![指示書の承認状況パネル](../../../assets/screenshots/work-order-approval-01.png)

- 承認できるのは、その段の **承認グループに入っている人** と、期間を決めて代理を任された人だけです。入っていない場合はボタンが出ず、「◯◯ のメンバーのみ承認・差し戻しできます」と表示されます。
