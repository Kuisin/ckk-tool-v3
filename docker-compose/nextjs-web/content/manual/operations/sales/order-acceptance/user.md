---
title: "受注請書 — 操作マニュアル"
description: "お客様から届いた注文書を自動で読み取り、内容を確認して、受注明細を作るところまで進めるアプリです。"
...
---
お客様から届いた注文書（PDF やスキャンした画像）をコンピューターが自動で読み取り、内容を確認して **受注明細** を作るところまで進めるアプリです。操作コードは `SA04` です。
...
- 上長の承認をもらってから、明細 1 行につき 1 枚の **受注明細** をまとめて作れます。
...
- **受注明細（じゅちゅうめいさい）** … 受注請書の明細 1 行ごとに作られる、社内の製造・出荷のもとになる伝票です。
- **明細（めいさい）** … 注文の中の 1 行のことです。「どの製品を何本」を書きます。
- **受注確定（でんぴょうてんかい）** … 受注請書から受注明細をまとめて作る操作のことです。
...
![受注確定の確認画面](../../../assets/screenshots/order-acceptance-deploy-01.png)

明細 1 行につき 1 枚の受注明細が作られます。番号は受注請書の番号に `-01`、`-02` … と続き番号が付きます。作られた受注明細は、画面の「**生成された受注明細**」のリンク、または一覧右上の「**受注明細一覧**」から開けます。
