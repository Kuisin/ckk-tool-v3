...
---
These settings let you prepare, in advance, the input boxes that appear when you register a [product](/manual/en/operations/masters/product/user). The settings are split into two screens.
...
A box called 「**製品種別**」 (Product type) appears on the new [product](/manual/en/operations/masters/product/user) screen.
