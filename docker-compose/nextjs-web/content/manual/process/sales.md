...
| 5. 受注を確定する | 受諾した内容から受注明細が作られます（製品ごと） | 社内営業補助 | 受注明細（`PD01`） |
...
### 5〜6. 受注の確定と製造の指示（受注明細・指示書）

受注請書を確定すると、明細ごとに **受注明細** が作られます。続いて、その受注明細に対して **指示書** を作ります。指示書では在庫から出す分と新しく作る分を分け、工程を順番に並べます。ここから先は生産の流れになります。
...
**受注請書が次に進まない**
承認依頼が済んでいるか、承認者が承認したかを確認してください。承認済みになると受注明細・指示書へ展開できます。
