...
- Click the name under 「**ユーザー**」 (User) and that person's details open in [ユーザー管理](/manual/en/system/user-management/user) (User Management).
...
A. They are records of apps being switched on or off for display in [アプリ管理](/manual/en/system/app-management/user) (App Management).
