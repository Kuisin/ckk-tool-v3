---
title: "ユーザー設定マニュアル"
description: "自分のアカウントに関する設定です。右上のアバターメニュー →「プロフィール」/「通知設定」/「ホーム画面設定」から開きます。"
screenshots: [profile-home-01]
---
自分のアカウントに関する設定です。右上のアバターメニュー →「プロフィール」/「通知設定」/「ホーム画面設定」から開きます。
...
- マニュアル（/manual）は右上の言語リンクで日本語 / English / 中文 を切り替えられます。
