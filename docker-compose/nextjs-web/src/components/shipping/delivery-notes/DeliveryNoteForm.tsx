 ...
 * `?shippingOrder=SHP-…` でプリセレクト可）を選択すると、納品先（= 受注明細の
...
export function DeliveryNoteForm({
  ...
  return (
    ...
    >
      ...
      <FormSection
        description="出荷書を選択すると明細が既定生成されます（単価は受注明細の単価）。価格記載 OFF のときは単価・金額を保存しません。"
        title="明細"
      >
