...
- **Work orders (指示書)** … first and second approval ([Work Order](/docs/apps/work-order/user) PD02).
- **Material purchase orders (素材発注書)** … pre-order approval ([Purchase Order](/docs/apps/purchase-order/user) PU03).
- **Purchase requests (購買依頼)** … [Purchase Request](/docs/apps/purchase-request/user) PU04.
