...
In both cases, the material is added to the receiving plant's [material inventory (素材在庫, PD05)](/docs/apps/material-inventory/user) at the same time the record is created. Registration requires the material-receipt permission.
