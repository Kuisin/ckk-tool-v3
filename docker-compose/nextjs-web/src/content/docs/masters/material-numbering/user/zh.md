...
操作代码 **MS0C**。用于管理组装 [材种](/docs/masters/material-type/user) 代码和 [素材](/docs/masters/material/user) 代码的"零件"（构成要素）的画面。
...
- 直径・全长在新建 [素材](/docs/masters/material/user) 时如未登记也会自动登记。在这里手动添加，是为了提前准备选项或整理名称。
