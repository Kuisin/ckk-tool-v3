# Suppliers & Subcontractors — User Manual
...
Along with basic company information, you can register closing day, payment terms, bank account for payments, and standard lead time. Companies registered here become selectable in [purchase orders (素材発注書)](/docs/apps/purchase-order/user) and [outsource orders (外注依頼)](/docs/apps/outsource-order/user).
...
New here? See the [Start Manual](/docs/start) as well.
