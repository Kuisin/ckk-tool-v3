...
Every ON/OFF operation is written to the audit log. In the [Activity Log](/docs/system/activity-log) (target "アプリ管理 / App Management") you can see who toggled which app, in which environment, and when.
...
- Per-user permissions can be reviewed in [User Management](/docs/system/user-management).
