...
- For the documents that generate these files, see their app manuals, e.g. [Quote (見積書)](/docs/apps/quote/user) and [Invoice (請求書)](/docs/apps/invoice/user).
