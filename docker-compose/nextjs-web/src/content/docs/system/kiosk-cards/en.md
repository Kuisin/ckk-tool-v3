...
- Device-side management (linking, activation, floor maps): see [Kiosk Device Management](/docs/system/kiosk-devices).
- Initial setup of the tablet itself: see [Kiosk Device Setup](/docs/system/kiosk-device-setup).
