...
export const USER_OPTIONS: Option[] = Object.entries(USERS).map(
...
export const MATERIALS: Option[] = [
  {
    value: "GU20F-B003-033",
    label: "GU20F-B003-033 — GU20F研磨 φ3（研磨）",
  },
  {
    value: "A01A0001-A001-001",
    label: "A01A0001-A001-001 — SUS303 φ20×3000（研磨）",
  },
  {
    value: "A02B0014-B001-002",
    label: "A02B0014-B001-002 — SKD11 φ32×2500（定尺）",
  },
  {
    value: "B01A0007-A002-001",
    label: "B01A0007-A002-001 — S45C φ16×4000（研磨）",
  },
];
