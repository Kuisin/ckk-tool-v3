...
ALTER ROLE studio_ro  IN DATABASE ckk SET search_path = auth, master, bp, sales, production, inventory, shipping, billing, design, sys, log, kot, directory, admintools;
...
GRANT USAGE ON SCHEMA auth, master, bp, sales, production, inventory,
                     shipping, billing, design, sys, log TO app;
GRANT ALL ON ALL TABLES    IN SCHEMA auth, master, bp, sales, production, inventory, shipping, billing, design, sys, log TO app;
GRANT ALL ON ALL SEQUENCES IN SCHEMA auth, master, bp, sales, production, inventory, shipping, billing, design, sys, log TO app;
ALTER DEFAULT PRIVILEGES IN SCHEMA auth, master, bp, sales, production, inventory, shipping, billing, design, sys, log GRANT ALL ON TABLES TO app;
ALTER DEFAULT PRIVILEGES IN SCHEMA auth, master, bp, sales, production, inventory, shipping, billing, design, sys, log GRANT ALL ON SEQUENCES TO app;
...
GRANT USAGE ON SCHEMA kot, directory, admintools, auth, master, bp, sales,
                     production, inventory, shipping, billing, design, sys, log TO studio_ro;
GRANT SELECT ON ALL TABLES IN SCHEMA kot, directory, admintools, auth, master, bp, sales, production, inventory, shipping, billing, design, sys, log TO studio_ro;
ALTER DEFAULT PRIVILEGES IN SCHEMA auth, master, bp, sales, production, inventory, shipping, billing, design, sys, log, kot, directory GRANT SELECT ON TABLES TO studio_ro;
